...
public class MetadataSyncServiceImpl implements MetadataSyncService {
    ...
    public void syncMetadata(Long dataSourceId) {
        ...
        try {
            // 获取数据源实体
            com.insightdata.domain.model.DataSource dataSourceEntity = dataSourceRepository.findById(dataSourceId)
    ...
    private void syncSchemas(DataSourceAdapter dataSourceAdapter, com.insightdata.domain.model.DataSource dataSource, MetadataSyncJob syncJob)
            throws SQLException {
    ...
    private void syncTables(DataSourceAdapter dataSourceAdapter, com.insightdata.domain.model.DataSource dataSource, SchemaInfo schemaInfo, MetadataSyncJob syncJob)
            throws SQLException {
