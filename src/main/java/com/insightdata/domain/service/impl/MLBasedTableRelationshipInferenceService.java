...
public class MLBasedTableRelationshipInferenceService implements TableRelationshipInferenceService {
    ...
    @Override
    public List<TableRelationship> inferRelationshipsFromContent(Long dataSourceId, SchemaInfo schemaInfo) {
    ...
    @Override
    public List<TableRelationship> inferRelationshipsFromColumnNames(Long dataSourceId, SchemaInfo schemaInfo) {
    ...
    @Override
    public List<TableRelationship> inferRelationshipsFromCommonPatterns(Long dataSourceId, SchemaInfo schemaInfo) {
    ...
    @Override
    public List<TableRelationship> inferRelationships(Long dataSourceId, SchemaInfo schemaInfo) {
        ...
        for (TableRelationship relationship : allRelationships) {
            ...
            if (!relationshipMap.containsKey(key) || 
                relationshipMap.get(key).getWeight() < relationship.getWeight()) {
    ...
    @Override
    public List<TableRelationship> recommendRelationships(Long dataSourceId, String tableName, double confidence, int limit) {
        ...
        List<TableRelationship> relatedRelationships = allRelationships.stream()
            ...
            .filter(r -> r.getWeight() >= confidence)
            .sorted(Comparator.comparingDouble(TableRelationship::getWeight).reversed())
            .limit(limit)
            .collect(Collectors.toList());
    ...
    private TableRelationship createRelationship(Long dataSourceId, String sourceTable, String sourceColumn,
                                            String targetTable, String targetColumn, RelationshipType type,
                                            RelationshipSource source, double weight) {
        // 创建表关系对象
