    ...
    e = function() {
        ...
        function w(e, r, n, o) {
            ...
            if (i) {
                ...
                for (var s in i)
                    e.props && s in e.props || (a[s] = i[s], delete i[s])
            }
        }
        function b(t, e, r) {
            var n = t.charAt(0);
        ...
        function j(t, e) {
            for (var r, n = [], o = 0, i = 0, a = "", s = e && e.delimiter || "/"; null != (r = _.exec(t));) {
                var u = r[0],
                    c = r[1],
                    p = r.index;
                if (a += t.slice(i, p), i = p + u.length, c)
                    a += c[1];
                else {
                    var f = t[i],
                        h = r[2],
        ...
        var H,
            ...
            F = {
                ...
                render: function(e) {
                    ...
                    f[g] = v(o, w, this.exactPath),
                        f[m] = this.exact || this.exactPath ? f[g] : function(t, e) {
                    ...
                    if ("a" === this.tag)
                        ...
                        if (C) {
                            ...
                            for (var j in R)
                                j in A.on ? A.on[j].push(R[j]) : A.on[j] = x;
        ...
        function Q(t, e) {
                ...
                if (c) {
                    ...
                    if ("object" != typeof s.params && (s.params = {}), r && "object" == typeof r.params)
                        for (var h in r.params)
                            !(h in s.params) && f.indexOf(h) > -1 && (s.params[h] = r.params[h]);
            ...
            return {
                ...
                addRoute: function(t, e) {
                    ...
                    K([e || t], n, o, i, r),
                    r && r.alias.length && K(r.alias.map((function(t) {
                        return {
                            path: t,
                            children: [e]
                        }
        ...
        function rt() {
            ...
            return n.key = Z(), window.history.replaceState(n, "", r), window.addEventListener("popstate", it), function() {
        ...
        var ft,
            ht = D && (-1 === (ft = window.navigator.userAgent).indexOf("Android 2.") && -1 === ft.indexOf("Android 4.0") || -1 === ft.indexOf("Mobile Safari") || -1 !== ft.indexOf("Chrome") || -1 !== ft.indexOf("Windows Phone")) && window.history && "function" == typeof window.history.pushState;
        function lt(e, r) {
            ot();
        ...
        function yt(t, e) {
            return gt(t, e, vt.redirected, 'Redirected when going from "' + t.fullPath + '" to "' + function(t) {
                if ("string" == typeof t)
                    return t;
                if ("path" in t)
                    return t.path;
        ...
        function mt(t, e) {
            return gt(t, e, vt.cancelled, 'Navigation cancelled from "' + t.fullPath + '" to "' + e.fullPath + '" with a new navigation.')
        }
        function gt(t, e, r, n) {
            var o = new Error(n);
        ...
        function xt(t, e) {
            return bt(t) && t._isRouter && (null == e || t.type === e)
        }
        function Rt(t, e, r) {
            var n = function(o) {
                ...
                Et(t, (function(t, e, r, s) {
                    if ("function" == typeof t && void 0 === t.cid) {
                        ...
                        var u,
                            c = Ot((function(e) {
                                var o;
                                ((o = e).__esModule || At && "Module" === o[Symbol.toStringTag]) && (e = e.default),
        ...
        _t.prototype.listen = function(t) {
            ...
            _t.prototype.transitionTo = function(t, e, r) {
                ...
                this.confirmTransition(n, (function() {
                    ...
                    r && r(t),
                    t && !o.ready && (xt(t, vt.redirected) && i === h || (o.ready = !0, o.readyErrorCbs.forEach((function(e) {
                        e(t)
                    }))))
                }))
            },
            _t.prototype.confirmTransition = function(t, e, r) {
                ...
                var i,
                    a,
                    s = function(t) {
                        !xt(t) && bt(t) && (n.errorCbs.length ? n.errorCbs.forEach((function(e) {
                            e(t)
                        })) : console.error(t)),
                        r && r(t)
                    },
                ...
                if (v(t, o) && u === c && t.matched[u] === o.matched[c])
                    return this.ensureURL(), t.hash && nt(this.router, o, t, !1), s(((a = gt(i = o, t, vt.duplicated, 'Avoided redundant navigation to current location: "' + i.fullPath + '".')).name = "NavigationDuplicated", a));
                var p = function(t, e) {
                        var r,
                        ...
                        try {
                            e(t, o, (function(e) {
                                !1 === e ? (n.ensureURL(!0), s(function(t, e) {
                                    return gt(t, e, vt.aborted, 'Navigation aborted from "' + t.fullPath + '" to "' + e.fullPath + '" via a navigation guard.')
                                }(o, t))) : bt(e) ? (n.ensureURL(!0), s(e)) : "string" == typeof e || "object" == typeof e && ("string" == typeof e.path || "string" == typeof e.name) ? (s(yt(o, t)), "object" == typeof e && e.replace ? n.replace(e) : n.push(e)) : r(e)
                            }))
                        } catch (t) {
                            s(t)
                        }
                            ...
                            return function(t, e, r) {
                                return function(n, o, i) {
                                    return t(n, o, (function(t) {
                                        "function" == typeof t && (e.enteredCbs[r] || (e.enteredCbs[r] = []), e.enteredCbs[r].push(t)),
                                            i(t)
                                    }))
                                }
                            }(t, r, n)
        ...
        var St = function(t) {
            function e(e, r) {
                t.call(this, e, r),
                    this._startLocation = Pt(this.base)
            }
        ...
        Vt.prototype.match = function(t, e, r) {
        ...
        return Vt.install = function t(e) {
            if (!t.installed || H !== e) {
                t.installed = !0,
                    H = e;
                var r = function(t) {
                ...
                e.mixin({
                    beforeCreate: function() {
                        r(this.$options.router) ? (this._routerRoot = this, this._router = this.$options.router, this._router.init(this), e.util.defineReactive(this, "_route", this._router.history.current)) : this._routerRoot = this.$parent && this.$parent._routerRoot || this,
                            n(this, this)
                    },
                    destroyed: function() {
                        n(this)
                    ...
                    e.component("RouterLink", F);
                var o = e.config.optionMergeStrategies;
                o.beforeRouteEnter = o.beforeRouteLeave = o.beforeRouteUpdate = o.created
            }
        }, Vt.version = "3.6.5", Vt.isNavigationFailure = xt, Vt.NavigationFailureType = vt, Vt.START_LOCATION = h, D && window.Vue && window.Vue.use(Vt), Nt
    },
