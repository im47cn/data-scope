!function(t) {
    "object" == typeof exports && "object" == typeof module ? t(require("../../codemirror.min")) : "function" == typeof define && define.amd ? define(["../../codemirror.min.js"], t) : t(CodeMirror)
}(function(T) {
    "use strict";
    ...
    function n(t, e) {
        ...
        this.options.updateOnCursorActivity && t.on("cursorActivity", (i = this).activityFunc = function() {
            i.cursorActivity()
        })
    }
    ...
    function O(t, e) {
        for (; e && e != t;) {
            if ("LI" === e.nodeName.toUpperCase() && e.parentNode == t)
                return e;
            e = e.parentNode
        }
    }
    function i(o, t) {
        ...
        var f = o.options.container || c.body,
            ...
            y = 0,
            b = 0;
        f !== c.body && (w = (C = -1 !== ["absolute", "relative", "fixed"].indexOf(r.getComputedStyle(f).position) ? f : f.offsetParent).getBoundingClientRect(), H = c.body.getBoundingClientRect(), y = w.left - H.left - C.scrollLeft, b = w.top - H.top - C.scrollTop),
            l.style.left = m - y + "px",
            l.style.top = g - b + "px";
        ...
        f.appendChild(l),
            ...
            s.getInputField().setAttribute("aria-activedescendant", this.id + "-" + this.selectedHint);
        var A,
        ...
        0 < H.bottom - w && (f = H.bottom - H.top, 0 < p.top - (p.bottom - H.top) - f ? (l.style.top = (g = p.top - f - b) + "px", v = !1) : w < f && (l.style.height = w - 5 + "px", l.style.top = (g = p.bottom - H.top - b) + "px", x = s.getCursor(), t.from.ch != x.ch && (p = s.cursorCoords(x), l.style.left = (m = p.left - y) + "px", H = l.getBoundingClientRect())));
        var k,
            x = H.right - e;
        ...
        s.addKeyMap(this.keyMap = function(t, n) {
            var o = {
                Up: function() {
                    n.moveFocus(-1)
                },
            ...
            var e = t.options.customKeys,
                s = e ? {} : o;
            function i(t, e) {
                var i = "string" != typeof e ? function(t) {
                    return e(t, n)
                } : o.hasOwnProperty(e) ? o[e] : e;
                s[t] = i
            }
            if (e)
                for (var c in e)
                    e.hasOwnProperty(c) && i(c, e[c]);
        ...
        o.options.closeOnUnfocus && (s.on("blur", this.onBlur = function() {
            ...
            s.on("scroll", this.onScroll = function() {
                ...
                if (v || (n += l.offsetHeight), n <= e.top || n >= e.bottom)
                    return o.close();
                l.style.top = i + "px",
                    l.style.left = m + A.left - t.left + "px"
            }),
    ...
    n.prototype = {
        ...
        pick: function(t, e) {
            ...
            this.cm.operation(function() {
                i.hint ? i.hint(n.cm, t, i) : n.cm.replaceRange(M(i), i.from || t.from, i.to || t.to, "complete"),
                    T.signal(t, "pick", i),
                    n.cm.scrollIntoView()
            }),
        ...
        cursorActivity: function() {
            ...
            i.line != this.startPos.line || n.length - i.ch != this.startLen - this.startPos.ch || i.ch < t.ch || this.cm.somethingSelected() || !i.ch || this.options.closeCharacters.test(n.charAt(i.ch - 1)) ? this.close() : ((e = this).debounce = o(function() {
                e.update()
        ...
        update: function(e) {
            var i,
                n;
            null != this.tick && (n = ++(i = this).tick, r(this.options.hint, this.cm, this.options, function(t) {
        ...
        finishUpdate: function(t, e) {
            ...
            (this.data = t) && t.list.length && (e && 1 == t.list.length ? this.pick(t, 0) : (this.widget = new i(this, t), T.signal(t, "shown")))
        }
    },
        i.prototype = {
            close: function() {
                var t;
                this.completion.widget == this && (this.completion.widget = null, this.hints.parentNode && this.hints.parentNode.removeChild(this.hints), this.completion.cm.removeKeyMap(this.keyMap), (t = this.completion.cm.getInputField()).removeAttribute("aria-activedescendant"), t.removeAttribute("aria-owns"), t = this.completion.cm, this.completion.options.closeOnUnfocus && (t.off("blur", this.onBlur), t.off("focus", this.onFocus)), t.off("scroll", this.onScroll))
            },
            disable: function() {
            ...
            changeActive: function(t, e) {
                ...
                this.selectedHint != t && ((e = this.hints.childNodes[this.selectedHint]) && (e.className = e.className.replace(" " + F, ""), e.removeAttribute("aria-selected")), (e = this.hints.childNodes[this.selectedHint = t]).className += " " + F, e.setAttribute("aria-selected", "true"), this.completion.cm.getInputField().setAttribute("aria-activedescendant", e.id), this.scrollToActive(), T.signal(this.data, "select", this.data.list[this.selectedHint], e))
            },
            scrollToActive: function() {
                ...
                e.offsetTop < this.hints.scrollTop ? this.hints.scrollTop = e.offsetTop - t.offsetTop : i.offsetTop + i.offsetHeight > this.hints.scrollTop + this.hints.clientHeight && (this.hints.scrollTop = i.offsetTop + i.offsetHeight - this.hints.clientHeight + t.offsetTop)
            },
        ...
        T.registerHelper("hint", "auto", {
            resolve: function(t, e) {
                ...
                return (i = t.getHelper(t.getCursor(), "hintWords")) ? function(t) {
                    return T.hint.fromList(t, {
                        words: i
                    })
                } : T.hint.anyword ? function(t, e) {
