!function(e, t) {
    ...
    function _() {}
    function q(e, t) {
        e = Object.create ? Object.create(e) : (_.prototype = e, new _);
        return t && P(t, e), e
    }
    ...
    var se,
        ...
        ce,
        he,
        de = (se = /[\u0590-\u05f4\u0600-\u06ff\u0700-\u08ac]/, ae = /[stwN]/, ue = /[LRr]/, ce = /[Lb1n]/, he = /[1n]/, function(e, t) {
            var n = "ltr" == t ? "L" : "R";
            ...
            for (var O, A = [], D = 0; D < i;)
                if (ce.test(o[D])) {
                    ...
                    for (var E = H; E < D;)
                        if (he.test(o[E])) {
                            H < E && (A.splice(F, 0, new fe(1, H, E)), F += P);
                            var I = E;
            ...
            return "ltr" == t && (1 == A[0].level && (O = e.match(/^\s+/)) && (A[0].from = O[0].length, A.unshift(new fe(0, 0, O[0].length))), 1 == Y(A).level && (O = e.match(/\s+$/)) && (Y(A).to -= O[0].length, A.push(new fe(0, i - O[0].length, i)))), "rtl" == t ? A.reverse() : A
        });
    function fe(e, t, n) {
        this.level = e,
            this.from = t,
    ...
    function we(e, t, n) {
        ...
        }), be(e, n || t.type, e, t), Te(t) || t.codemirrorIgnore
    }
    function xe(e) {
    ...
    function Oe(e) {
        var t = e.which;
        return null == t && (1 & e.button ? t = 1 : 2 & e.button ? t = 3 : 4 & e.button && (t = 2)), t = g && e.ctrlKey && 1 == t ? 3 : t
    }
    var Ae,
        De,
        We = function() {
    ...
    var He = 3 != "\n\nb".split(/\n/).length ? function(e) {
        ...
        Pe = "oncopy" in (r = M("div")) || (r.setAttribute("oncopy", "return;"), "function" == typeof r.oncopy),
        Ee = null;
    var Ie = {},
        Re = {};
    function ze(e) {
    ...
    function Be(e, t) {
        ...
        if (Ge.hasOwnProperty(t.name)) {
            var i,
                o = Ge[t.name];
            for (i in o)
                o.hasOwnProperty(i) && (r.hasOwnProperty(i) && (r["_" + i] = r[i]), r[i] = o[i])
        }
    ...
    function tt(e, t, n) {
        if (void 0 === n && (n = null), !(this instanceof tt))
            return new tt(e, t, n);
        this.line = e,
            this.ch = t,
            this.sticky = n
    ...
    function at(e, t) {
        ...
        return t.line > n ? tt(n, Ye(e, n).text.length) : (e = Ye(e, (n = t).line).text.length, null == (t = n.ch) || e < t ? tt(n.line, e) : t < 0 ? tt(n.line, 0) : n)
    }
    function ut(e, t) {
    ...
    Xe.prototype.eol = function() {
        ...
        Xe.prototype.column = function() {
            return this.lastColumnPos < this.start && (this.lastColumnValue = E(this.string, this.start, this.tabSize, this.lastColumnPos, this.lastColumnValue), this.lastColumnPos = this.start), this.lastColumnValue - (this.lineStart ? E(this.string, this.lineStart, this.tabSize) : 0)
        },
    ...
    function ft(e, t, n) {
        var r,
            i,
            o;
        return t.styles && t.styles[0] == e.state.modeGen || (r = pt(e, Ze(t)), i = t.text.length > e.options.maxHighlightLength && Ve(e.doc.mode, r.state), o = dt(e, t, r), i && (r.state = i), t.stateAfter = r.save(!i), t.styles = o.styles, o.classes ? t.styleClasses = o.classes : t.styleClasses && (t.styleClasses = null), n === e.doc.highlightFrontier && (e.doc.modeFrontier = Math.max(e.doc.modeFrontier, ++e.doc.highlightFrontier))), t.styles
    }
    function pt(n, r, e) {
        var t = n.doc,
            i = n.display;
    ...
    function xt(e, t, n, r, i, o, l) {
        ...
        for ("" == t && wt(mt(n, r.state), o); !c.eol();) {
            var d,
                f = c.pos > e.options.maxHighlightLength ? (s = !1, l && gt(e, t, r, c.pos), c.pos = t.length, null) : wt(vt(n, c, r.state, h), o);
    ...
    function Tt(e, t) {
                ...
                if (e)
                    for (var i = 0; i < e.length; ++i) {
                        var o,
                            l = e[i],
                            s = l.marker;
                        !(null == l.from || (s.inclusiveLeft ? l.from <= t : l.from < t)) && (l.from != t || "bookmark" != s.type || n && l.marker.insertLeft) || (o = null == l.to || (s.inclusiveRight ? l.to >= t : l.to > t), (r = r || []).push(new Lt(s, l.from, o ? null : l.to)))
                    }
                return r
            }(n, i, e),
            s = function(e, t, n) {
                ...
                if (e)
                    for (var i = 0; i < e.length; ++i) {
                        var o,
                            l = e[i],
                            s = l.marker;
                        !(null == l.to || (s.inclusiveRight ? l.to >= t : l.to > t)) && (l.from != t || "bookmark" != s.type || n && !l.marker.insertLeft) || (o = null == l.from || (s.inclusiveLeft ? l.from <= t : l.from < t), (r = r || []).push(new Lt(s, o ? null : l.from - t, null == l.to ? null : l.to - t)))
                    }
                return r
            }(r, o, e),
            a = 1 == t.text.length,
        ...
        if (s)
            for (var f = 0; f < s.length; ++f) {
                var p = s[f];
                null != p.to && (p.to += u),
                    null == p.from ? kt(l, p.marker) || (p.from = u, a && (l = l || []).push(p)) : (p.from += u, a && (l = l || []).push(p))
            }
        l = l && Mt(l),
        s && s != l && (s = Mt(s));
        var g = [l];
    ...
    function $t(e, t) {
        ...
        for (var i = 0; i <= (t.rest ? t.rest.length : 0); i++) {
            ...
            function(e) {
                ...
                return L(e), n && n.left != n.right && (De = t.right - n.right < 3)
                            ...
                            if (v == p) {
                                ...
                                if (!h || h.from == p)
                                    for (var k = 0; k < y.length; ++k)
                                        Zt(t, 0, y[k]);
                                if (h && (h.from || 0) == p) {
                                    if (Zt(t, (null == h.to ? f + 1 : h.to) - p, h.marker, null == h.from), null == h.to)
                                        return;
                                    h.to == p && (h = !1)
                                }
                            }
            ...
            o.styleClasses && (o.styleClasses.bgClass && (r.bgClass = D(o.styleClasses.bgClass, r.bgClass || "")), o.styleClasses.textClass && (r.textClass = D(o.styleClasses.textClass, r.textClass || ""))),
            0 == r.map.length && r.map.push(0, 0, r.content.appendChild(function(e) {
                null == Ae && (t = M("span", "​"), k(e, M("span", [t, document.createTextNode("x")])), 0 != e.firstChild.offsetHeight && (Ae = t.offsetWidth <= 1 && 2 < t.offsetHeight && !(w && v < 8)));
        ...
        return f && (n = r.content.lastChild, (/\bcm-tab\b/.test(n.className) || n.querySelector && n.querySelector(".cm-tab")) && (r.content.className = "cm-tab-wrap-hack")), be(e, "renderLine", e, t.line, r.pre), r.pre.className && (r.textClass = D(r.pre.className, r.textClass || "")), r
    }
    function _t(e) {
        ...
        if (t) {
            ...
            if (a.test(t))
                for (var c = document.createDocumentFragment(), h = 0;;) {
                    ...
                    if (f && (p = document.createTextNode(s.slice(h, h + f)), w && v < 9 ? c.appendChild(M("span", [p])) : c.appendChild(p), e.map.push(e.pos, e.pos + f, p), e.col += f, e.pos += f), !d)
                        break;
                    h += 1 + f;
                    var p = void 0;
                    "\t" == d[0] ? (f = (f = e.cm.options.tabSize) - e.col % f, (p = c.appendChild(M("span", X(f), "cm-tab"))).setAttribute("role", "presentation"), p.setAttribute("cm-text", "\t"), e.col += f) : ("\r" == d[0] || "\n" == d[0] ? (p = c.appendChild(M("span", "\r" == d[0] ? "␍" : "␤", "cm-invalidchar"))).setAttribute("cm-text", d[0]) : ((p = e.cm.options.specialCharPlaceholder(d[0])).setAttribute("cm-text", d[0]), w && v < 9 ? c.appendChild(M("span", [p])) : c.appendChild(p)), e.col += 1),
    ...
    function rn(e, t) {
        ...
        if (n.length) {
            ...
            en ? r = en.delayedCallbacks : nn ? r = nn : (r = nn = [], setTimeout(on, 0));
        ...
        for (var i = 0; i < t.changes.length; i++) {
            ...
            "text" == o ? function(e, t) {
                ...
                t.text.parentNode.replaceChild(r.pre, t.text),
                    t.text = r.pre,
                    r.bgClass != t.bgClass || r.textClass != t.textClass ? (t.bgClass = r.bgClass, t.textClass = r.textClass, un(e, t)) : n && (t.text.className = n)
    ...
    function an(e, t) {
        ...
        return n && n.line == t.line ? (e.display.externalMeasured = null, t.measure = n.measure, n.built) : $t(e, t)
    }
    function un(e, t) {
        var n,
            r;
        ...
        (r = (i = t).bgClass ? i.bgClass + " " + (i.line.bgClass || "") : i.line.bgClass) && (r += " CodeMirror-linebackground"),
            i.background ? r ? i.background.className = r : (i.background.parentNode.removeChild(i.background), i.background = null) : r && (e = sn(i), i.background = e.insertBefore(M("div", null, r), e.firstChild), n.display.input.setUneditable(i.background)),
    ...
    function cn(e, t, n, r) {
        ...
        t.line.gutterClass && (o = sn(t), t.gutterBackground = M("div", null, "CodeMirror-gutter-background " + t.line.gutterClass, "left: " + (e.options.fixedGutter ? r.fixedPos : -r.gutterTotalWidth) + "px; width: " + r.gutterTotalWidth + "px"), e.display.input.setUneditable(t.gutterBackground), o.insertBefore(t.gutterBackground, t.text));
        ...
        if (e.options.lineNumbers || i) {
            ...
            if (l.setAttribute("aria-hidden", "true"), e.display.input.setUneditable(l), o.insertBefore(l, t.text), t.line.gutterClass && (l.className += " " + t.line.gutterClass), !e.options.lineNumbers || i && i["CodeMirror-linenumbers"] || (t.lineNumber = l.appendChild(M("div", et(e.options, n), "CodeMirror-linenumber CodeMirror-gutter-elt", "left: " + r.gutterLeft["CodeMirror-linenumbers"] + "px; width: " + e.display.lineNumInnerWidth + "px"))), i)
    ...
    function fn(e) {
        ...
        var t,
            n = e.doc.cm;
        return n ? (N(document.body, e.node) || (t = "position: relative;", e.coverGutter && (t += "margin-left: -" + n.display.gutters.offsetWidth + "px;"), e.noHScroll && (t += "width: " + n.display.wrapper.clientWidth + "px;"), k(n.display.measure, M("div", [e.node], null, t))), e.height = e.node.parentNode.offsetHeight) : 0
    }
    function pn(e, t) {
    ...
    function Ln(e, t) {
        var n,
            ...
            i = Ze(t),
            o = Sn(e, i);
        o && !o.text ? o = null : o && o.changes && (ln(e, o, i, _n(e)), e.curOp.forceUpdate = !0),
        o || (n = e, e = Ze(r = It(r = t)), (r = n.display.externalMeasured = new Qt(n.doc, r, e)).lineN = e, e = r.built = $t(n, r), r.text = e.pre, k(n.display.lineMeasure, e.pre), o = r);
        i = xn(o, t, i);
        return {
            line: t,
            view: o,
    ...
    function kn(e, t, n, r, i) {
        ...
        return t.cache.hasOwnProperty(l) ? o = t.cache[l] : (t.rect || (t.rect = t.view.text.getBoundingClientRect()), t.hasHeights || (function(e, t, n) {
            ...
            !(w && v < 9) || s || i && (i.left || i.right) || (m = l.parentNode.getClientRects()[0], i = m ? {
                left: m.left,
    ...
    function Pn(e, t, n, r, i) {
        if (i || (i = Fn(t), n.top += i, n.bottom += i), "line" == r)
            return n;
        r = r || "local";
        t = Gt(t);
        return "local" == r ? t += gn(e.display) : t -= e.display.viewOffset, "page" != r && "window" != r || (t += (e = e.display.lineSpace.getBoundingClientRect()).top + ("window" == r ? 0 : Hn()), r = e.left + ("window" == r ? 0 : Wn()), n.left += r, n.right += r), n.top += t, n.bottom += t, n
    }
    function En(e, t, n) {
        if ("div" == n)
            return t;
        var r = t.left,
            t = t.top;
        "page" == n ? (r -= Wn(), t -= Hn()) : "local" != n && n || (r += (n = e.display.sizer.getBoundingClientRect()).left, t += n.top);
    ...
    function Rn(n, e, r, i, o, l) {
        function s(e, t) {
            ...
            return t ? e.left = e.right : e.right = e.left, Pn(n, i, e, r)
        }
        i = i || Ye(n.doc, e.line),
            o = o || Ln(n, i);
        var a = pe(i, n.doc.direction),
            t = e.ch,
            u = e.sticky;
        if (t >= i.text.length ? (t = i.text.length, u = "before") : t <= 0 && (t = 0, u = "after"), !a)
    ...
    function zn(e, t) {
        var n = 0;
        t = at(e.doc, t),
        e.options.lineWrapping || (n = $n(e.display) * t.ch);
        t = Ye(e.doc, t.line),
            e = Gt(t) + gn(e.display);
        return {
            left: n,
    ...
    function Gn(e, t, n) {
        ...
        for (var l = Ye(r, i);;) {
            var s = function(n, e, t, r, i) {
                    ...
                    c && (f = (n.options.lineWrapping ? Xn : jn)(n, e, t, o, c, r, i), u = 1 != f.level, s = u ? f.from : f.to - 1, a = u ? f.to : f.from - 1);
                    var h = null,
                        d = null,
                        c = ie(function(e) {
                            var t = kn(n, o, e);
                            return t.top += l, t.bottom += l, Kn(t, r, i, !1) && (t.top <= i && t.left <= r && (h = e, d = t), 1)
                        }, s, a),
                        f = !1;
                    {
                        var p,
                            g;
                        d ? (p = r - d.left < d.right - r, c = h + ((g = p == u) ? 0 : 1), g = g ? "after" : "before", p = p ? d.left : d.right) : (u || c != a && c != s || c++, g = 0 == c || c != e.text.length && kn(n, o, c - (u ? 1 : 0)).bottom + l <= i == u ? "after" : "before", u = Rn(n, tt(t, c, g), "line", e, o), p = u.left, f = i < u.top ? -1 : i >= u.bottom ? 1 : 0)
                    }
                    return c = re(e.text, c, 1), Bn(t, c, g, f, r - p)
                }(e, l, i, t, n),
                a = function(e, t) {
                    var n,
                        r = St && e.markedSpans;
    ...
    function jn(n, r, i, o, l, s, a) {
        var e,
            ...
            u = l[t];
        return 0 < t && (e = 1 != u.level, Kn(e = Rn(n, tt(i, e ? u.from : u.to, e ? "after" : "before"), "line", r, o), s, a, !0) && e.top > a && (u = l[t - 1])), u
    }
    function Xn(e, t, n, r, i, o, l) {
        ...
        for (var u = null, c = null, h = 0; h < i.length; h++) {
            var d,
                f = i[h];
            f.from >= a || f.to <= s || (d = (d = kn(e, r, 1 != f.level ? Math.min(a, f.to) - 1 : Math.max(s, f.from)).right) < o ? o - d + 1e9 : d - o, (!u || d < c) && (u = f, c = d))
        }
    ...
    function Zn(r) {
        var i = Yn(r.display),
            ...
            l = o && Math.max(5, r.display.scroller.clientWidth / $n(r.display) - 3);
        return function(e) {
            if (Bt(r.doc, e))
                return 0;
            var t = 0;
    ...
    function Jn(e, t, n, r) {
        ...
        if (!n && "true" == Ne(t).getAttribute("cm-not-content"))
            return null;
        var o,
            i = i.lineSpace.getBoundingClientRect();
        try {
            o = t.clientX - i.left,
                s = t.clientY - i.top
        } catch (e) {
        ...
        var l,
            s = Gn(e, o, s);
        return r && 0 < s.xRel && (l = Ye(e.doc, s.line).text).length == s.ch && (l = E(l, l.length, e.options.tabSize) - l.length, s = tt(s.line, Math.max(0, Math.round((o - vn(e.display).left) / $n(e.display)) - l))), s
    }
    function er(e, t) {
    ...
    function tr(e, t, n, r) {
        ...
        (r = r || 0) && n < l.viewTo && (null == l.updateLineNumbers || l.updateLineNumbers > t) && (l.updateLineNumbers = t),
            ...
            t >= l.viewTo ? St && Rt(e.doc, t) < l.viewTo && rr(e) : n <= l.viewFrom ? St && zt(e.doc, n + r) > l.viewFrom ? rr(e) : (l.viewFrom += r, l.viewTo += r) : t <= l.viewFrom && n >= l.viewTo ? rr(e) : t <= l.viewFrom ? (i = ir(e, n, n + r, 1)) ? (l.view = l.view.slice(i.index), l.viewFrom = i.lineN, l.viewTo += r) : rr(e) : n >= l.viewTo ? (o = ir(e, t, t, -1)) ? (l.view = l.view.slice(0, o.index), l.viewTo = o.lineN) : rr(e) : (i = ir(e, t, t, -1), o = ir(e, n, n + r, 1), i && o ? (l.view = l.view.slice(0, i.index).concat(Jt(e, i.lineN, o.lineN)).concat(l.view.slice(o.index)), l.viewTo += r) : rr(e));
    ...
    function sr(e, t) {
        ...
        for (var s, a, u, c = 0; c < n.sel.ranges.length; c++)
            !t && c == n.sel.primIndex || ((s = n.sel.ranges[c]).from().line >= e.display.viewTo || s.to().line < e.display.viewFrom || (a = s.empty(), l ? (u = l(e, s)) && ar(e, u, i) : (a || e.options.showCursorWhenSelecting) && ar(e, s.head, i), a || function(i, e, t) {
                var n = i.display,
                    o = i.doc,
                ...
                function s(n, g, m) {
                    ...
                    return function(e, t, n, r) {
                        ...
                        var i,
                            ...
                            f = 0 == r,
                            p = !C || r == C.length - 1;
                        c.top - u.top <= 3 ? (i = (k ? h : d) && f ? S : (a ? u : c).left, r = (k ? d : h) && p ? L : (a ? c : u).right, T(i, u.top, r - i, u.bottom)) : (n = a ? (o = k && h && f ? S : u.left, l = k ? L : x(e, n, "before"), s = k ? S : x(t, n, "after"), k && d && p ? L : c.right) : (o = k ? x(e, n, "before") : S, l = !k && h && f ? L : u.right, s = !k && d && p ? S : c.left, k ? x(t, n, "after") : L), T(o, u.top, l - o, u.bottom), u.bottom < c.top && T(S, u.bottom, null, c.top), T(s, c.top, n - s, c.bottom)),
                        (!v || ur(u, v) < 0) && (v = u),
                        ur(c, v) < 0 && (v = c),
                        (!y || ur(u, y) < 0) && (y = u),
                        ur(c, y) < 0 && (y = c)
                ...
                var a = e.from(),
                    n = e.to();
                a.line == n.line ? s(a.line, a.ch, n.ch) : (r = Ye(o, a.line), e = Ye(o, n.line), e = It(r) == It(e), r = s(a.line, a.ch, e ? r.text.length + 1 : null).end, n = s(n.line, e ? 0 : null, n.ch).start, e && (r.top < n.top - 2 ? (T(r.right, r.top, null, r.bottom), T(S, n.top, n.left, n.bottom)) : T(r.right, r.top, n.left - r.right, r.bottom)), r.bottom < n.top && T(S, r.bottom, null, n.top));
                t.appendChild(l)
            }(e, s, o)));
        return r
    }
    function ar(e, t, n) {
        ...
        /\bcm-fat-cursor\b/.test(e.getWrapperElement().className) && (t = (t = In(e, t, "div", null, null)).right - t.left, i.style.width = (0 < t ? t : e.defaultCharWidth()) + "px"),
        r.other && ((n = n.appendChild(M("div", " ", "CodeMirror-cursor CodeMirror-secondarycursor"))).style.display = "", n.style.left = r.other.left + "px", n.style.top = r.other.top + "px", n.style.height = .85 * (r.other.bottom - r.other.top) + "px")
    }
    function ur(e, t) {
    ...
    function fr(e, t) {
        ...
        "nocursor" != e.options.readOnly && (e.state.focused || (be(e, "focus", e, t), e.state.focused = !0, A(e.display.wrapper, "CodeMirror-focused"), e.curOp || e.display.selForContextMenu == e.doc.sel || (e.display.input.reset(), f && setTimeout(function() {
            return e.display.input.reset(!0)
        }, 20)), e.display.input.receivedFocus()), cr(e))
    }
    function pr(e, t) {
        e.state.delayingBlurEvent || (e.state.focused && (be(e, "blur", e, t), e.state.focused = !1, S(e.display.wrapper, "CodeMirror-focused")), clearInterval(e.display.blinker), setTimeout(function() {
    ...
    function gr(e) {
        for (var t = e.display, n = t.lineDiv.offsetTop, r = Math.max(0, t.scroller.getBoundingClientRect().top), i = t.lineDiv.getBoundingClientRect().top, o = 0, l = 0; l < t.view.length; l++) {
            ...
            if (!a.hidden) {
                i += a.line.height,
                    w && v < 8 ? (c = (s = a.node.offsetTop + a.node.offsetHeight) - n, n = s) : (c = (d = a.node.getBoundingClientRect()).bottom - d.top, !u && a.text.firstChild && (h = a.text.firstChild.getBoundingClientRect().right - d.left - 1));
                var d = a.line.height - c;
                if ((.005 < d || d < -.005) && (i < r && (o -= d), qe(a.line, c), mr(a.line), a.rest))
                    for (var f = 0; f < a.rest.length; f++)
                        mr(a.rest[f]);
                h > e.display.sizerWidth && ((h = Math.ceil(h / $n(e.display))) > e.display.maxLineLength && (e.display.maxLineLength = h, e.display.maxLine = a.line, e.display.maxLineChanged = !0))
            }
        }
    ...
    function vr(e, t, n) {
        var r = n && null != n.top ? Math.max(0, n.top) : e.scroller.scrollTop,
            ...
            o = Qe(t, r),
            r = Qe(t, i);
        return n && n.ensure && (i = n.ensure.from.line, n = n.ensure.to.line, i < o ? r = Qe(t, Gt(Ye(t, o = i)) + e.wrapper.clientHeight) : Math.min(n, t.lastLine()) >= r && (o = Qe(t, Gt(Ye(t, n)) - e.wrapper.clientHeight), r = n)), {
            from: o,
            to: Math.max(r, o + 1)
        }
    }
    ...
    function Tr(e, t, n, r) {
        ...
        (n ? t == e.doc.scrollLeft : Math.abs(e.doc.scrollLeft - t) < 2) && !r || (e.doc.scrollLeft = t, Yr(e), e.display.scroller.scrollLeft != t && (e.display.scroller.scrollLeft = t), e.display.scrollbars.setScrollLeft(t))
    }
    function Mr(e) {
        var t = e.display,
    ...
    function Dr(n) {
        n.display.scrollbars && (n.display.scrollbars.clear(), n.display.scrollbars.addClass && S(n.display.wrapper, n.display.scrollbars.addClass)),
                    ...
                    !function(e) {
                        ...
                        null != e.scrollLeft && Tr(t, e.scrollLeft, !0, !0);
                        {
                            ...
                            e.scrollToPos && (i = function(e, t, n, r) {
                                null == r && (r = 0),
                                e.options.lineWrapping || t != n || (n = "before" == t.sticky ? tt(t.line, t.ch + 1, "before") : t, t = t.ch ? tt(t.line, "before" == t.sticky ? t.ch - 1 : t.ch, "after") : t);
                                for (var i = 0; i < 5; i++) {
                                    var o,
                                        l = !1,
                                        s = Rn(e, t),
                                        ...
                                        s = e.doc.scrollTop,
                                        a = e.doc.scrollLeft;
                                    if (null != u.scrollTop && (Lr(e, u.scrollTop), 1 < Math.abs(e.doc.scrollTop - s) && (l = !0)), null != u.scrollLeft && (Tr(e, u.scrollLeft), 1 < Math.abs(e.doc.scrollLeft - a) && (l = !0)), !l)
                                        break
                                }
                                return o
                            }(t, at(r, e.scrollToPos.from), at(r, e.scrollToPos.to), e.scrollToPos.margin), function(e, t) {
                                var n,
                                    r,
                                    i;
                                we(e, "scrollCursorIntoView") || (r = (n = e.display).sizer.getBoundingClientRect(), i = null, t.top + r.top < 0 ? i = !0 : t.bottom + r.top > (window.innerHeight || document.documentElement.clientHeight) && (i = !1), null == i || u || (t = M("div", "​", null, "position: absolute;\n                         top: " + (t.top - n.viewOffset - gn(e.display)) + "px;\n                         height: " + (t.bottom - t.top + yn(e) + n.barHeight) + "px;\n                         left: " + t.left + "px; width: " + Math.max(2, t.right - t.left) + "px;"), e.display.lineSpace.appendChild(t), t.scrollIntoView(i), e.display.lineSpace.removeChild(t)))
                            }(t, i))
                        }
    ...
    function Br(l) {
        var s,
            ...
            u,
            c = l.doc;
        c.highlightFrontier >= l.display.viewTo || (s = +new Date + l.options.workTime, a = pt(l, c.highlightFrontier), u = [], c.iter(a.line, Math.min(c.first + c.size, l.display.viewTo + 500), function(e) {
            if (a.line >= l.display.viewFrom) {
                ...
                e.text.length <= l.options.maxHighlightLength && gt(l, e.text, a),
                    ...
                    a.nextLine();
            if (+new Date > s)
                return zr(l, l.options.workDelay), !0
        }), c.highlightFrontier = a.line, c.modeFrontier = Math.max(c.modeFrontier, a.line), u.length && Pr(l, function() {
    ...
    function Ur(e, t) {
        ...
        St && (o = Rt(e.doc, o), l = zt(e.doc, l));
        var s = o != n.viewFrom || l != n.viewTo || n.lastWrapHeight != t.wrapperHeight || n.lastWrapWidth != t.wrapperWidth;
        r = o,
            i = l,
            0 == (l = (o = e).display).view.length || r >= l.viewTo || i <= l.viewFrom ? (l.view = Jt(o, r, i), l.viewFrom = r) : (l.viewFrom > r ? l.view = Jt(o, r, l.viewFrom).concat(l.view) : l.viewFrom < r && (l.view = l.view.slice(er(o, r))), l.viewFrom = r, l.viewTo < i ? l.view = l.view.concat(Jt(o, l.viewTo, i)) : l.viewTo > i && (l.view = l.view.slice(0, er(o, i)))),
            l.viewTo = i,
        ...
        l = function(e) {
            ...
            return !window.getSelection || (t = window.getSelection()).anchorNode && t.extend && N(e.display.lineDiv, t.anchorNode) && (n.anchorNode = t.anchorNode, n.anchorOffset = t.anchorOffset, n.focusNode = t.focusNode, n.focusOffset = t.focusOffset), n
        }(e);
        return 4 < o && (n.lineDiv.style.display = "none"), function(n, e, t) {
            ...
            function s(e) {
                var t = e.nextSibling;
                return f && g && n.display.currentWheelTarget == e ? e.style.display = "none" : e.parentNode.removeChild(e), t
            }
            for (var a = r.view, u = r.viewFrom, c = 0; c < a.length; c++) {
                ...
                if (!h.hidden)
                    if (h.node && h.node.parentNode == o) {
                        ...
                        h.changes && (-1 < R(h.changes, "gutter") && (d = !1), ln(n, h, u, t)),
                        d && (L(h.lineNumber), h.lineNumber.appendChild(document.createTextNode(et(n.options, u)))),
                            l = h.node.nextSibling
                    } else {
                        d = function(e, t, n, r) {
                            var i = an(e, t);
                            return t.text = t.node = i.pre, i.bgClass && (t.bgClass = i.bgClass), i.textClass && (t.textClass = i.textClass), un(e, t), cn(e, t, n, r), hn(e, t, r), t.node
                        }(n, h, u, t);
                        o.insertBefore(d, l)
                    }
                u += h.size
    ...
    function Vr(e, t) {
        for (var n = t.viewport, r = !0;; r = !1) {
            ...
            }), t.visible = vr(e.display, e.doc, n), t.visible.from >= e.display.viewFrom && t.visible.to <= e.display.viewTo)
                break;
            if (!Ur(e, t))
                break;
            gr(e);
    ...
    function Kr(e, t) {
        var n = new Gr(e, t);
        Ur(e, n) && (gr(e), Vr(e, n), t = Mr(e), lr(e), Nr(e, t), Xr(e, t), n.finish())
    }
    function jr(e) {
        ...
        if (e.options.lineNumbers) {
            ...
            if (n.length != r.lineNumChars) {
                var i = r.measure.appendChild(M("div", [M("div", n)], "CodeMirror-linenumber CodeMirror-gutter-elt")),
                    ...
                    i = i.offsetWidth - t;
                return r.lineGutter.style.width = "", r.lineNumInnerWidth = Math.max(t, r.lineGutter.offsetWidth - i) + 1, r.lineNumWidth = r.lineNumInnerWidth + i, r.lineNumChars = r.lineNumInnerWidth ? n.length : -1, r.lineGutter.style.width = r.lineNumWidth + "px", jr(e.display), 1
            }
        }
    }
    function _r(e, t) {
    ...
    function Qr(e, t, n, r) {
        ...
        w && v < 8 && (i.gutters.style.zIndex = -1, i.scroller.style.paddingRight = 0),
        ...
        e && (e.appendChild ? e.appendChild(i.wrapper) : e(i.wrapper)),
            ...
            i.activeTouch = null,
            i.gutterSpecs = _r(r.gutters, r.lineNumbers),
            qr(i),
            n.init(i)
    }
    ...
    function ri(e, t) {
        ...
        if (r && a || i && n) {
            if (i && g && f)
                e:
                    for (var u = t.target, c = l.view; u != s; u = u.parentNode)
            ...
            if (r && !d && !p && null != o)
                return i && n && Lr(e, Math.max(0, s.scrollTop + i * o)), Tr(e, Math.max(0, s.scrollLeft + r * o)), i && !n || Le(t), void (l.wheelStartX = null);
            i && null != o && (n = (a = e.doc.scrollTop) + l.wrapper.clientHeight, (o = i * o) < 0 ? a = Math.max(0, a + o - 50) : n = Math.min(e.doc.height, n + o + 50), Kr(e, {
                top: a,
                bottom: n
            })),
            Jr < 20 && 0 !== t.deltaMode && (null == l.wheelStartX ? (l.wheelStartX = s.scrollLeft, l.wheelStartY = s.scrollTop, l.wheelDX = r, l.wheelDY = i, setTimeout(function() {
                var e,
                    t;
                null != l.wheelStartX && (t = s.scrollLeft - l.wheelStartX, t = (e = s.scrollTop - l.wheelStartY) && l.wheelDY && e / l.wheelDY || t && l.wheelDX && t / l.wheelDX, l.wheelStartX = l.wheelStartY = null, t && (ei = (ei * Jr + t) / (Jr + 1), ++Jr))
    ...
    function li(e, t, n) {
        ...
        for (var i = 1; i < t.length; i++) {
            var o,
                ...
                s = t[i - 1],
                a = nt(s.to(), l.from());
            (r && !l.empty() ? 0 < a : 0 <= a) && (o = lt(s.from(), l.from()), a = ot(s.to(), l.to()), s = s.empty() ? l.from() == l.head : s.from() == s.head, i <= n && --n, t.splice(--i, 2, new oi(s ? a : o, s ? o : a)))
        }
        return new ii(t, n)
    }
    function si(e, t) {
    ...
    function ui(e, t) {
        ...
        var n = e.line + t.text.length - (t.to.line - t.from.line) - 1,
            r = e.ch;
        return e.line == t.to.line && (r += ai(t).ch - t.to.ch), tt(n, r)
    }
    function ci(e, t) {
    ...
    function Ci(e, t, n, r) {
        ...
        var o,
            l,
            s = +new Date;
        if ((i.lastOp == r || i.lastOrigin == t.origin && t.origin && ("+" == t.origin.charAt(0) && i.lastModTime > s - (e.cm ? e.cm.options.historyEventDelay : 500) || "*" == t.origin.charAt(0))) && (o = (a = i).lastOp == r ? (xi(a.done), Y(a.done)) : a.done.length && !Y(a.done).ranges ? Y(a.done) : 1 < a.done.length && !a.done[a.done.length - 2].ranges ? (a.done.pop(), Y(a.done)) : void 0))
            l = Y(o.changes),
    ...
    function Si(e, t, n, r) {
        var i,
            ...
            s = e.history,
            a = r && r.origin;
        n == s.lastSelOp || a && s.lastSelOrigin == a && (s.lastModTime == s.lastSelTime && s.lastOrigin == a || (i = e, o = a, l = Y(s.done), e = t, "*" == (o = o.charAt(0)) || "+" == o && l.ranges.length == e.ranges.length && l.somethingSelected() == e.somethingSelected() && new Date - i.history.lastSelTime <= (i.cm ? i.cm.options.historyEventDelay : 500))) ? s.done[s.done.length - 1] = t : Li(t, s.done),
            ...
            if (o.ranges)
                ...
                for (var a = 0; a < l.length; ++a) {
                    ...
                    if (s.push({
                        ...
                        for (var h in c)
                            (u = h.match(/^spans_(\d+)$/)) && -1 < R(t, Number(u[1])) && (Y(s)[h] = c[h], delete c[h])
                }
            }
        }
        return r
    ...
    function Oi(e, t, n, r) {
        if (r) {
            r = e.anchor;
            return n && ((e = nt(t, r) < 0) != nt(n, r) < 0 ? (r = t, t = n) : e != nt(t, n) < 0 && (t = n)), new oi(r, t)
        }
        return new oi(n || t, t)
    }
    ...
    function Ei(e, t, n) {
        var r,
            i;
        (Ce(e, "beforeSelectionChange") || e.cm && Ce(e.cm, "beforeSelectionChange")) && (r = e, i = n, i = {
            ranges: (o = t).ranges,
            update: function(e) {
                this.ranges = [];
                for (var t = 0; t < e.length; t++)
            ...
            origin: i && i.origin
        }, be(r, "beforeSelectionChange", r, i), r.cm && be(r.cm, "beforeSelectionChange", r.cm, i), t = i.ranges != o.ranges ? li(r.cm, i.ranges, i.ranges.length - 1) : o);
        var o = n && n.bias || (nt(t.primary().head, e.sel.primary().head) < 0 ? -1 : 1);
        Ii(e, zi(e, t, o, !0)),
        n && !1 === n.scroll || !e.cm || "nocursor" == e.cm.getOption("readOnly") || wr(e.cm)
    }
    function Ii(e, t) {
        t.equals(e.sel) || (e.sel = t, e.cm && (e.cm.curOp.updateInput = 1, e.cm.curOp.selectionChanged = !0, xe(e.cm)), rn(e, "cursorActivity", e))
    }
    function Ri(e) {
        ...
        if (o.markedSpans)
            for (var l = 0; l < o.markedSpans.length; ++l) {
                ...
                if ((null == s.from || (u ? s.from <= t.ch : s.from < t.ch)) && (null == s.to || (c ? s.to >= t.ch : s.to > t.ch))) {
                    if (i && (be(a, "beforeCursorEnter"), a.explicitlyCleared)) {
                        if (o.markedSpans) {
                            --l;
                            continue
                        }
    ...
    function Gi(e, t, n, r, i) {
        ...
        return r || (e.cantEdit = !0, tt(e.first, 0))
    }
    function Ui(e, t, n, r) {
    ...
    function Ki(i, e, t) {
        ...
        return t && (o.update = function(e, t, n, r) {
            ...
            n && (o.text = n),
            void 0 !== r && (o.origin = r)
        }), be(i, "beforeChange", i, o), i.cm && be(i.cm, "beforeChange", i.cm, o), o.canceled ? (i.cm && (i.cm.curOp.updateInput = 2), null) : {
            from: o.from,
            to: o.to,
            text: o.text,
            origin: o.origin
                ...
                for (var i = [{
                    ...
                    for (var l = r[o], s = l.find(0), a = 0; a < i.length; ++a) {
                        var u,
                            ...
                            h,
                            d = i[a];
                        nt(d.to, s.from) < 0 || 0 < nt(d.from, s.to) || (u = [a, 1], c = nt(d.from, s.from), h = nt(d.to, s.to), (c < 0 || !l.inclusiveLeft && !c) && u.push({
                            from: d.from,
                            to: s.from
    ...
    function Xi(e, n) {
        var t,
            r;
        1 == n.text.length && "" == n.text[0] && 0 == nt(n.from, n.to) || (t = ci(e, n), Ci(e, n, t, e.cm ? e.cm.curOp.id : NaN), _i(e, n, t, Tt(e, n)), r = [], mi(e, function(e, t) {
    ...
    function _i(e, t, n, r) {
        if (e.cm && !e.cm.curOp)
            return Er(e.cm, _i)(e, t, n, r);
        var i;
        t.to.line < e.first ? $i(e, t.text.length - 1 - (t.to.line - t.from.line)) : t.from.line > e.lastLine() || (t.from.line < e.first && ($i(e, i = t.text.length - 1 - (e.first - t.from.line)), t = {
            from: tt(e.first, 0),
            ...
            text: [t.text[0]],
            origin: t.origin
        } : t).removed = $e(e, t.from, t.to), n = n || ci(e, t), e.cm ? function(e, t, n) {
            var r = e.doc,
                i = e.display,
                o = t.from,
                l = t.to,
                s = !1,
                a = o.line;
            e.options.lineWrapping || (a = Ze(It(Ye(r, o.line))), r.iter(a, l.line + 1, function(e) {
                if (e == i.maxLine)
                    return s = !0
            }));
            ...
            (a || r) && (t = {
                ...
                removed: t.removed,
                origin: t.origin
            }, a && rn(e, "change", e, t), r && (e.curOp.changeObjs || (e.curOp.changeObjs = [])).push(t));
            e.display.selForContextMenu = null
        }(e.cm, t, r) : gi(e, t, r), Ei(e, n, G), e.cantEdit && Gi(e, tt(e.firstLine(), 0)) && (e.cantEdit = !1))
    }
    function qi(e, t, n, r, i) {
        var o;
        nt(r = r || n, n) < 0 && (n = (o = [r, n])[0], r = o[1]),
    ...
    function eo(e, t, n, r) {
        var i = t,
            o = t;
        return "number" == typeof t ? o = Ye(e, st(e, t)) : i = Ze(t), null == i ? null : (r(o, i) && e.cm && nr(e.cm, i, n), o)
    }
    function to(e) {
        this.lines = e,
            this.parent = null;
        ...
        no.prototype = {
                ...
                for (var n, r = 0; r < this.children.length; ++r) {
                    ...
                    if (e < o) {
                        var l = Math.min(t, o - e),
                            s = i.height;
                        if (i.removeInner(e, l), this.height -= s - i.height, o == l && (this.children.splice(r--, 1), i.parent = null), 0 == (t -= l))
                            break;
                        e = 0
                    } else
                        e -= o
                }
                this.size - t < 25 && (1 < this.children.length || !(this.children[0] instanceof to)) && (this.collapse(n = []), this.children = [new to(n)], this.children[0].parent = this)
            },
            collapse: function(e) {
            ...
            maybeSpill: function() {
                if (!(this.children.length <= 10)) {
                    ...
                    } while (e.parent ? (e.size -= n.size, e.height -= n.height, t = R(e.parent.children, e), e.parent.children.splice(t + 1, 0, n)) : (((t = new no(e.children)).parent = e).children = [t, n], e = t), n.parent = e.parent, 10 < e.children.length);
                    e.parent.maybeSpill()
                }
            },
            iterN: function(e, t, n) {
    ...
    ro.prototype.clear = function() {
        ...
        ro.prototype.changed = function() {
            ...
            this.height = null;
            var i = fn(this) - t;
            i && (Bt(this.doc, r) || qe(r, r.height + i), n && Pr(n, function() {
    ...
    function so(r, i, o, e, t) {
        ...
        var l = new oo(r, t),
            t = nt(i, o);
        if (e && P(e, l, !1), 0 < t || 0 == t && !1 !== l.clearWhenEmpty)
            return l;
        if (l.replacedWith && (l.collapsed = !0, l.widgetNode = T("span", [l.replacedWith], "CodeMirror-widget"), e.handleMouseEvents || l.widgetNode.setAttribute("cm-ignore-events", "true"), e.insertLeft && (l.widgetNode.insertLeft = !0)), l.collapsed) {
        ...
        if (r.iter(a, o.line + 1, function(e) {
            ...
            l.collapsed && a != i.line && qe(e, 0),
                ...
                (e = (e = r.cm && r.cm.curOp) && window.WeakSet && (e.markedSpans || (e.markedSpans = new WeakSet))) && e.has(t.markedSpans) ? t.markedSpans.push(n) : (t.markedSpans = t.markedSpans ? t.markedSpans.concat([n]) : [n], e && e.add(t.markedSpans)),
            ...
            return l.clear()
        }), l.readOnly && (Ct = !0, (r.history.done.length || r.history.undone.length) && r.clearHistory()), l.collapsed && (l.id = ++lo, l.atomic = !0), u) {
    ...
    oo.prototype.clear = function() {
        if (!this.explicitlyCleared) {
            ...
            for (var r = null, i = null, o = 0; o < this.lines.length; ++o) {
                ...
                t && !this.collapsed ? nr(t, Ze(l), "text") : t && (null != s.to && (i = Ze(l)), null != s.from && (r = Ze(l))),
            ...
            this.atomic && this.doc.cantEdit && (this.doc.cantEdit = !1, t && Ri(t.doc)),
        ...
        oo.prototype.find = function(e, t) {
            ...
            for (var i = 0; i < this.lines.length; ++i) {
                ...
                if (null != l.from && (n = tt(t ? o : Ze(o), l.from), -1 == e))
                    return n;
                if (null != l.to && (r = tt(t ? o : Ze(o), l.to), 1 == e))
                    return r
            }
            return n && {
                from: n,
        ...
        oo.prototype.changed = function() {
            ...
            r && o && Pr(o, function() {
                var e = r.line,
                    t = Ze(r.line),
                    t = Sn(o, t);
                t && (On(t), o.curOp.selectionChanged = o.curOp.forceUpdate = !0),
                    o.curOp.updateMaxLine = !0,
                Bt(i.doc, e) || null == i.height || (t = i.height, i.height = null, (t = fn(i) - t) && qe(e, e.height + t)),
    ...
    (ho.prototype = q(no.prototype, {
        ...
        extendSelectionsBy: Rr(function(e, t) {
            Di(this, ut(this, $(this.sel.ranges, e)), t)
        }),
            ...
            for (var t = t && "end" != t && function(e, t, n) {
                for (var r = [], i = u = tt(e.first, 0), o = 0; o < t.length; o++) {
                    var l = t[o],
                        ...
                        u = l.to,
                        i = a;
                    "around" == n ? (l = nt((l = e.sel.ranges[o]).head, l.anchor) < 0, r[o] = new oi(l ? a : s, l ? s : a)) : r[o] = new oi(s, s)
                }
        ...
        clearGutter: Rr(function(t) {
            ...
            this.iter(function(e) {
                e.gutterMarkers && e.gutterMarkers[t] && eo(n, e, "gutter", function() {
                    return e.gutterMarkers[t] = null, ee(e.gutterMarkers) && (e.gutterMarkers = null), 1
                })
            })
        }),
        lineInfo: function(e) {
        ...
        addLineWidget: Rr(function(e, t, n) {
            return e = e, i = new ro(r = this, t, n), (o = r.cm) && i.noHScroll && (o.display.alignWidgets = !0), eo(r, e, "widget", function(e) {
                var t = e.widgets || (e.widgets = []);
                return null == i.insertAt ? t.push(i) : t.splice(Math.min(t.length, Math.max(0, i.insertAt)), 0, i), i.line = e, o && !Bt(r, e) && (t = Gt(e) < r.scrollTop, qe(e, e.height + fn(i)), t && br(o, i.height), o.curOp.forceUpdate = !0), 1
            }), o && rn(o, "lineWidgetAdded", o, i, "number" == typeof e ? e : Ze(e)), i;
            var r,
                i,
                o
        }),
        ...
        copy: function(e) {
            var t = new ho(_e(this, this.first, this.first + this.size), this.modeOption, this.first, this.lineSep, this.direction);
        ...
        linkedDoc: function(e) {
            ...
            t = new ho(_e(this, t, n), e.mode || this.modeOption, t, this.lineSep, this.direction);
            return e.sharedHist && (t.history = this.history), (this.linked || (this.linked = [])).push({
                ...
                for (var n = 0; n < t.length; n++) {
                    var r = t[n],
                        ...
                        o = e.clipPos(i.from),
                        i = e.clipPos(i.to);
                    nt(o, i) && (i = so(e, o, i, r.primary, r.primary.type), r.markers.push(i), i.parent = r)
                }
            }(t, uo(this)), t
        },
        unlinkDoc: function(e) {
            ...
            e.history == this.history && (n = [e.id], mi(e, function(e) {
                return n.push(e.id)
            }, !0), e.history = new bi(null), e.history.done = Ni(this.history.done, n), e.history.undone = Ni(this.history.undone, n))
        },
            ...
            if (t && !r.isReadOnly())
                if (n && n.length && window.FileReader && window.File)
                    ...
                    if (r.state.draggingText && -1 < r.doc.sel.contains(t))
                        return r.state.draggingText(e), void setTimeout(function() {
                    ...
                    try {
                        ...
                        if (c) {
                            if (r.state.draggingText && !r.state.draggingText.copy && (u = r.listSelections()), Ei(r.doc, si(t, t)), u)
        ...
        for (t in e)
            if (e.hasOwnProperty(t)) {
                ...
                if (!/^(name|fallthrough|(de|at)tach)$/.test(t))
                    if ("..." != i) {
                        for (var o = $(t.split(" "), To), l = 0; l < o.length; l++) {
                            var s = void 0,
                                a = void 0,
    ...
    function Ao(e, t, n) {
        var r = e;
        return t.altKey && "Alt" != r && (e = "Alt-" + e), (b ? t.metaKey : t.ctrlKey) && "Ctrl" != r && (e = "Ctrl-" + e), (b ? t.ctrlKey : t.metaKey) && "Mod" != r && (e = "Cmd-" + e), e = !n && t.shiftKey && "Shift" != r ? "Shift-" + e : e
    }
    function Do(e, t) {
    ...
    function Eo(e, t, n, r, i) {
        if (e) {
            ...
            if (o) {
                ...
                return 0 < e.level || "rtl" == t.doc.direction ? (l = Ln(t, n), s = i < 0 ? n.text.length - 1 : 0, a = kn(t, l, s).top, s = ie(function(e) {
                    return kn(t, l, e).top == a
                }, i < 0 == (1 == e.level) ? e.from : e.to - 1, s), "before" == o && (s = Fo(n, s, 1))) : s = i < 0 ? e.to : e.from, new tt(r, s, o)
            }
        }
    ...
    function Io(t, n, s, e) {
        ...
        function o(e) {
            return t.options.lineWrapping ? (l = l || Ln(t, n), Vn(t, n, l, e)) : {
                begin: 0,
                end: n.text.length
            }
        }
    ...
    function Ko(e, t, n, r) {
        ...
        return "multi" == r && (e.state.keySeq = t), "handled" == r && rn(e, "keyHandled", e, t, n), "handled" != r && "multi" != r || (Le(n), cr(e)), !!r
    }
    function jo(t, e) {
        var n = Do(e, !0);
    ...
    function Jo(e) {
        var t,
            ...
            l = this,
            s = l.display;
        we(l, e) || s.activeTouch && s.input.supportsTouch() || (s.input.ensurePolled(), s.shift = e.shiftKey, pn(s, e) ? f || (s.scroller.draggable = !1, setTimeout(function() {
            return s.scroller.draggable = !0
        }, 100)) : nl(l, e) || (t = Jn(l, e), n = Oe(e), i = t ? (r = t, i = n, o = +new Date, Qo && Qo.compare(o, r, i) ? (Zo = Qo = null, "triple") : Zo && Zo.compare(o, r, i) ? (Qo = new qo(o, r, i), Zo = null, "double") : (Zo = new qo(o, r, i), Qo = null, "single")) : "single", window.focus(), 1 == n && l.state.selectingText && l.state.selectingText(e), t && function(n, e, r, t, i) {
            var o = "Click";
            ...
            (e.options.dragDrop && We && !e.isReadOnly() && "single" == n && -1 < (i = l.contains(t)) && (nt((i = l.ranges[i]).from(), t) < 0 || 0 < t.xRel) && (0 < nt(i.to(), t) || t.xRel < 0) ? function(t, n, r, i) {
                var o = t.display,
                    ...
                    s = Er(t, function(e) {
                        ...
                        l || (Le(e), i.addNew || Ai(t.doc, r, null, null, i.extend), f && !c || w && 9 == v ? setTimeout(function() {
                ...
                var m,
                    ...
                    y = g.sel,
                    t = y.ranges;
                p.addNew && !p.extend ? (v = g.sel.contains(f), m = -1 < v ? t[v] : new oi(f, f)) : (m = g.sel.primary(), v = g.sel.primIndex);
                "rectangle" == p.unit ? (p.addNew || (m = new oi(f, f)), f = Jn(d, e, !0, !0), v = -1) : (e = el(d, f, p.unit), m = p.extend ? Oi(m, e.anchor, e.head, p.extend) : e);
                p.addNew ? -1 == v ? (v = t.length, Pi(g, li(d, t.concat([m]), v), {
                    scroll: !1,
                    origin: "*mouse"
                })) : 1 < t.length && t[v].empty() && "char" == p.unit && !p.extend ? (Pi(g, li(d, t.slice(0, v).concat(t.slice(v + 1)), 0), {
                    scroll: !1,
                    origin: "*mouse"
                }), y = g.sel) : Wi(g, v, m, U) : (Pi(g, new ii([m], v = 0), U), y = g.sel);
                var b = f;
                function s(e) {
                    if (0 != nt(b, e))
                        if (b = e, "rectangle" == p.unit) {
                            ...
                            var h,
                                ...
                                i = el(d, e, p.unit),
                                e = r.anchor,
                                e = 0 < nt(i.anchor, e) ? (h = i.head, lt(r.from(), i.anchor)) : (h = i.anchor, ot(r.to(), i.head)),
                                i = y.ranges.slice(0);
                            i[v] = function(e, t) {
                                var n = t.anchor,
                                    r = t.head,
                                ...
                                if (0 == i || i == o.length)
                                    return t;
                                a = r.line != n.line ? 0 < (r.line - n.line) * ("ltr" == e.doc.direction ? 1 : -1) : (e = le(o, r.ch, r.sticky), a = e - l || (r.ch - n.ch) * (1 == s.level ? -1 : 1), e == i - 1 || e == i ? a < 0 : 0 < a);
                                var i = o[i + (a ? -1 : 0)],
                                    a = a == (1 == i.level),
                                    i = a ? i.from : i.to,
                                    a = a ? "after" : "before";
                ...
                var r = Er(d, function(e) {
                        (0 !== e.buttons && Oe(e) ? function e(t) {
                            ...
                            o && (0 != nt(o, b) ? (d.curOp.focus = O(), s(o), n = vr(l, g), (o.line >= n.to || o.line < n.from) && setTimeout(Er(d, function() {
                                u == i && e(t)
        ...
        }(l, t, i, e) : Ne(e) == s.scroller && Le(e) : 2 == n ? (t && Ai(l.doc, t), setTimeout(function() {
    ...
    function tl(e, t, n, r) {
        ...
        for (var s = 0; s < e.display.gutterSpecs.length; ++s) {
            ...
            if (a && a.getBoundingClientRect().right >= i)
                return be(e, n, e, Qe(e.doc, o), e.display.gutterSpecs[s].className, t), Te(t)
        }
    }
    function nl(e, t) {
    ...
    function rl(e, t) {
        var n,
            r;
        pn(e.display, t) || (r = t, Ce(n = e, "gutterContextMenu") && tl(n, r, "gutterContextMenu", !1)) || we(e, t, "contextmenu") || x || e.display.input.onContextMenu(t)
    }
    function il(e) {
    ...
    var ol = {
        ...
        sl = {};
    function al(e, t, n) {
        !t != !(n && n != ol) && (n = e.display.dragFunctions, (t = t ? me : ye)(e.display.scroller, "dragstart", n.start), t(e.display.scroller, "dragenter", n.enter), t(e.display.scroller, "dragover", n.over), t(e.display.scroller, "dragleave", n.leave), t(e.display.scroller, "drop", n.drop))
    }
    function ul(e) {
        e.options.lineWrapping ? (A(e.display.wrapper, "CodeMirror-wrap"), e.display.sizer.style.minWidth = "", e.display.sizerWidth = null) : (S(e.display.wrapper, "CodeMirror-wrap"), Vt(e)),
            Qn(e),
            tr(e),
            Dn(e),
            setTimeout(function() {
    ...
    function cl(e, t) {
        ...
        "string" == typeof r ? r = new ho(r, t.mode, null, t.lineSeparator, t.direction) : t.mode && (r.modeOption = t.mode),
            this.doc = r;
        var i,
            o = new cl.inputStyles[t.inputStyle](this),
            o = this.display = new Qr(e, r, o, t);
        for (i in il(o.wrapper.CodeMirror = this), t.lineWrapping && (this.display.wrapper.className += " CodeMirror-wrap"), Dr(this), this.state = {
            keyMaps: [],
            overlays: [],
            modeGen: 0,
            overwrite: !1,
            ...
            keySeq: null,
            specialChars: null
        }, t.autofocus && !h && o.input.focus(), w && v < 11 && setTimeout(function() {
            ...
            me(i.scroller, "mousedown", Er(r, Jo)),
                me(i.scroller, "dblclick", w && v < 11 ? Er(r, function(e) {
                    var t;
                    we(r, e) || (!(t = Jn(r, e)) || nl(r, e) || pn(r.display, e) || (Le(e), t = r.findWordAt(t), Ai(r.doc, t.anchor, t.head)))
                }) : function(e) {
                    return we(r, e) || Le(e)
                });
            ...
            me(i.scroller, "touchstart", function(e) {
                ...
                }(e) || nl(r, e) || (i.input.ensurePolled(), clearTimeout(n), t = +new Date, i.activeTouch = {
                    start: t,
                    moved: !1,
                ...
                me(i.scroller, "touchend", function(e) {
                    var t,
                        n = i.activeTouch;
                    n && !pn(i, e) && null != n.left && !n.moved && new Date - n.start < 300 && (t = r.coordsChar(i.activeTouch, "page"), t = !n.prev || s(n, n.prev) ? new oi(t, t) : !n.prev.prev || s(n, n.prev.prev) ? r.findWordAt(t) : new oi(tt(t.line, 0), at(r.doc, tt(t.line + 1, 0))), r.setSelection(t.anchor, t.head), r.focus(), Le(e)),
                        l()
                }),
                me(i.scroller, "touchcancel", l),
                me(i.scroller, "scroll", function() {
                    i.scroller.clientHeight && (Lr(r, i.scroller.scrollTop), Tr(r, i.scroller.scrollLeft, !0), be(r, "scroll", r))
                }),
                ...
                i.dragFunctions = {
                    ...
                    over: function(e) {
                        var t,
                            n;
                        we(r, e) || ((n = Jn(t = r, n = e)) && (ar(t, n, n = document.createDocumentFragment()), t.display.dragCursor || (t.display.dragCursor = M("div", null, "CodeMirror-cursors CodeMirror-dragcursors"), t.display.lineSpace.insertBefore(t.display.dragCursor, t.display.cursorDiv)), k(t.display.dragCursor, n)), Me(e))
                    },
                    start: function(e) {
                        var t,
                            n;
        ...
        }(this), bo(), Hr(this), this.curOp.forceUpdate = !0, vi(this, r), t.autofocus && !h || this.hasFocus() ? setTimeout(function() {
        ...
        if (e.options.indentWithTabs)
            for (var f = Math.floor(c / l); f; --f)
                d += l,
                    h += "\t";
        if (d < c && (h += X(c - d)), h != u)
            return qi(o, h, tt(t, 0), tt(t, u.length), "+input"), !(s.stateAfter = null);
    ...
    function gl(e, t, n, r, i) {
        ...
        if (s && 1 < r.ranges.length)
            if (fl && fl.text.join("\n") == t) {
                ...
                a.length == r.ranges.length && e.options.pasteLinesPerSelection && (u = $(a, function(e) {
                    return [e]
                }));
    ...
    function ml(e, t) {
        ...
        return n && (e.preventDefault(), t.isReadOnly() || t.options.disableInput || Pr(t, function() {
    ...
    function wl() {
        ...
        return f ? e.style.width = "1000px" : e.setAttribute("wrap", "off"), s && (e.style.border = "1px solid black"), bl(e), t
    }
    function xl(i, o, l, s, a) {
        ...
        function n(e) {
            var t,
                n,
                r;
            if (null == (n = "codepoint" == s ? (t = u.text.charCodeAt(o.ch + (0 < l ? 0 : -1)), isNaN(t) ? null : (n = 0 < l ? 55296 <= t && t < 56320 : 56320 <= t && t < 57343, new tt(o.line, Math.max(0, Math.min(u.text.length, o.ch + l * (n ? 2 : 1))), -l))) : a ? Io(i.cm, u, o, l) : Po(u, o, l))) {
                if (e || (r = o.line + c) < i.first || r >= i.first + i.size || (o = new tt(r, o.ch, o.sticky), !(u = Ye(i, r))))
                    return;
    ...
    function Cl(e, t, n, r) {
        var i,
            ...
            s = e.doc,
            a = t.left;
        for ("page" == r ? (i = Math.min(e.display.wrapper.clientHeight, window.innerHeight || document.documentElement.clientHeight), i = Math.max(i - .5 * Yn(e.display), 3), o = (0 < n ? t.bottom : t.top) + n * i) : "line" == r && (o = 0 < n ? t.bottom + 3 : t.top - 3); (l = Gn(e, a, o)).outside;) {
    ...
    e.prototype.init = function(e) {
            ...
            if (t.display.viewTo == t.display.viewFrom || r.line >= t.display.viewTo || i.line < t.display.viewFrom)
                ...
                if (!o || o.bad || !n || n.bad || 0 != nt(lt(o, n), r) || 0 != nt(ot(o, n), i)) {
                    ...
                    if (i || (i = {
                        ...
                        l && (!d && t.state.focused ? (e.collapse(r.node, r.offset), l.collapsed || (e.removeAllRanges(), e.addRange(l))) : (e.removeAllRanges(), e.addRange(l)), s && null == e.anchorNode ? e.addRange(s) : d && this.startGracePeriod()),
        ...
        e.prototype.focus = function() {
            "nocursor" != this.cm.options.readOnly && (this.selectionInEditor() && O() == this.div || this.showSelection(this.prepareSelection(), !0), this.div.focus())
        },
        ...
        e.prototype.pollSelection = function() {
            if (null == this.readDOMTimeout && !this.gracePeriod && this.selectionChanged()) {
                ...
                this.composing || (this.rememberSelection(), e = kl(r, n.anchorNode, n.anchorOffset), t = kl(r, n.focusNode, n.focusOffset), e && t && Pr(r, function() {
                    Pi(r.doc, si(e, t), G),
        ...
        e.prototype.pollContent = function() {
            ...
            var e,
                ...
                i = r.from(),
                r = r.to();
            if (0 == i.ch && i.line > t.firstLine() && (i = tt(i.line - 1, Ye(t.doc, i.line - 1).length)), r.ch == Ye(t.doc, r.line).text.length && r.line < t.lastLine() && (r = tt(r.line + 1, 0)), i.line < n.viewFrom || r.line > n.viewTo - 1)
                return !1;
            var o,
                l = i.line == n.viewFrom || 0 == (l = er(t, i.line)) ? (e = Ze(n.view[0].line), n.view[0].node) : (e = Ze(n.view[l].line), n.view[l - 1].node.nextSibling),
                r = er(t, r.line),
                ...
                for (; !function e(t) {
                    if (1 == t.nodeType) {
                        ...
                        if (n)
                            ...
                            (n = l.findMarks(tt(s, 0), tt(a + 1, 0), (o = +n, function(e) {
                                return e.id == o
                            }))).length && (r = n[0].find(0)) && f($e(l.doc, r.from, r.to).join(c));
                    ...
                    e = e.nextSibling,
                        h = !1;
                return n
            }(t, l, r, e, o)), a = $e(t.doc, tt(e, 0), tt(o, Ye(t.doc, o).text.length)); 1 < s.length && 1 < a.length;)
                if (Y(s) == Y(a))
                    s.pop(),
                        a.pop(),
                        o--;
            ...
            return 1 < s.length || s[0] || nt(l, r) ? (qi(t.doc, s, l, r, "+input"), !0) : void 0
        },
        ...
        e.prototype.onKeyPress = function(e) {
            0 == e.charCode || this.composing || (e.preventDefault(), this.cm.isReadOnly() || Er(this.cm, gl)(this.cm, String.fromCharCode(null == e.charCode ? e.keyCode : e.charCode), 0))
        },
    ...
    r.prototype.init = function(n) {
        ...
        s && (o.style.width = "0px"),
            ...
            me(o, "paste", function(e) {
                we(i, e) || ml(e, i) || (i.state.pasteIncoming = +new Date, r.fastPoll())
            }),
            me(o, "cut", t),
            me(o, "copy", t),
        ...
        r.prototype.prepareSelection = function() {
            var e,
                ...
                r = t.doc,
                i = sr(t);
            return t.options.moveInputWithCursor && (e = Rn(t, r.sel.primary().head, "div"), t = n.wrapper.getBoundingClientRect(), r = n.lineDiv.getBoundingClientRect(), i.teTop = Math.max(0, Math.min(n.wrapper.clientHeight - 10, e.top + r.top - t.top)), i.teLeft = Math.max(0, Math.min(n.wrapper.clientWidth - 10, e.left + r.left - t.left))), i
        },
        ...
        r.prototype.reset = function(e) {
            var t,
                n;
            this.contextMenuPending || this.composing || ((t = this.cm).somethingSelected() ? (this.prevInput = "", n = t.getSelection(), this.textarea.value = n, t.state.focused && H(this.textarea), w && 9 <= v && (this.hasSelection = n)) : e || (this.prevInput = this.textarea.value = "", w && 9 <= v && (this.hasSelection = null)))
        },
        ...
        r.prototype.onContextMenu = function(e) {
            ...
            function d() {
                var e,
                    t;
                n.contextMenuPending == d && (n.contextMenuPending = !1, n.wrapper.style.cssText = s, o.style.cssText = l, w && v < 9 && i.scrollbars.setScrollTop(i.scroller.scrollTop = c), null != o.selectionStart && ((!w || v < 9) && h(), e = 0, t = function() {
                    i.selForContextMenu == r.doc.sel && 0 == o.selectionStart && 0 < o.selectionEnd && "​" == n.prevInput ? Er(r, Vi)(r) : e++ < 10 ? i.detectingSelectAll = setTimeout(t, 500) : (i.selForContextMenu = null, i.input.reset())
                }, i.detectingSelectAll = setTimeout(t, 200)))
            }
            u && !p && (r.options.resetSelectionOnContextMenu && -1 == r.doc.sel.contains(u) && Er(r, Pi)(r.doc, si(u), G), l = o.style.cssText, s = n.wrapper.style.cssText, u = n.wrapper.offsetParent.getBoundingClientRect(), n.wrapper.style.cssText = "position: static", o.style.cssText = "position: absolute; width: 30px; height: 30px;\n      top: " + (e.clientY - u.top - 5) + "px; left: " + (e.clientX - u.left - 5) + "px;\n      z-index: 1000; background: " + (w ? "rgba(255, 255, 255, .05)" : "transparent") + ";\n      outline: none; border-width: 0; outline: none; overflow: hidden; opacity: .05; filter: alpha(opacity=5);", f && (t = window.scrollY), i.input.focus(), f && window.scrollTo(null, t), i.input.reset(), r.somethingSelected() || (o.value = n.prevInput = " "), n.contextMenuPending = d, i.selForContextMenu = r.doc.sel, clearTimeout(i.detectingSelectAll), w && 9 <= v && h(), x ? (Me(e), a = function() {
                ye(window, "mouseup", a),
                    setTimeout(d, 20)
        ...
        Dl("specialCharPlaceholder", _t, function(e) {
            return e.refresh()
        }, !0),
        Dl("electricChars", !0),
        ...
        Dl("gutters", [], function(e, t) {
            e.display.gutterSpecs = _r(t, e.options.lineNumbers),
                Zr(e)
        }, !0),
        ...
        Dl("lineNumbers", !1, function(e, t) {
            e.display.gutterSpecs = _r(e.options.gutters, t),
                Zr(e)
        }, !0),
        ...
        Nl.prototype = {
            ...
            setOption: function(e, t) {
                var n = this.options,
                    r = n[e];
                n[e] == t && "mode" != e || (n[e] = t, Ol.hasOwnProperty(e) && Er(this, Ol[e])(this, t, r), be(this, "optionChange", this, e))
            },
            ...
            indentSelection: Ir(function(e) {
                for (var t = this.doc.sel.ranges, n = -1, r = 0; r < t.length; r++) {
                    var i = t[r];
                    if (i.empty())
                        i.head.line > n && (dl(this, i.head.line, e, !0), n = i.head.line, r == this.doc.sel.primIndex && wr(this));
                    else {
            ...
            heightAtLine: function(e, t, n) {
                var r,
                    i = !1,
                    e = "number" == typeof e ? (r = this.doc.first + this.doc.size - 1, e < this.doc.first ? e = this.doc.first : r < e && (e = r, i = !0), Ye(this.doc, e)) : e;
                return Pn(this, e, {
                    top: 0,
                    left: 0
            ...
            addWidget: function(e, t, n, r, i) {
                var o,
                    l,
                    s = this.display,
                    a = (e = Rn(this, at(this.doc, e))).bottom,
                    u = e.left;
                t.style.position = "absolute",
                    t.setAttribute("cm-ignore-events", "true"),
                    this.display.input.setUneditable(t),
                    s.sizer.appendChild(t),
                    "over" == r ? a = e.top : "above" != r && "near" != r || (o = Math.max(s.wrapper.clientHeight, this.doc.height), l = Math.max(s.sizer.clientWidth, s.lineSpace.clientWidth), ("above" == r || e.bottom + t.offsetHeight > o) && e.top > t.offsetHeight ? a = e.top - t.offsetHeight : e.bottom + t.offsetHeight <= o && (a = e.bottom), u + t.offsetWidth > l && (u = l - t.offsetWidth)),
                    t.style.top = a + "px",
                    t.style.left = t.style.right = "",
                    "right" == i ? (u = s.sizer.clientWidth - t.offsetWidth, t.style.right = "0px") : ("left" == i ? u = 0 : "middle" == i && (u = (s.sizer.clientWidth - t.offsetWidth) / 2), t.style.left = u + "px"),
                n && (n = this, t = {
                    left: u,
                    top: a,
                    right: u + t.offsetWidth,
                    bottom: a + t.offsetHeight
                }, null != (t = yr(n, t)).scrollTop && Lr(n, t.scrollTop), null != t.scrollLeft && Tr(n, t.scrollLeft))
            },
            ...
            findPosV: function(e, t, n, r) {
                ...
                for (var l = at(this.doc, e), s = 0; s < t; ++s) {
                    var a = Rn(this, l, "div");
                    if (null == o ? o = a.left : a.left = o, (l = Cl(this, a, i, n)).hitSide)
                        break
                }
                return l
            },
            moveV: Ir(function(r, i) {
                ...
                if (l.extendSelectionsBy(function(e) {
                    ...
                    null != e.goalColumn && (t.left = e.goalColumn),
                        s.push(t.left);
                    var n = Cl(o, t, r, i);
                    return "page" == i && e == l.sel.primary() && br(o, In(o, n, "div").top - t.top), n
                }, V), s.length)
            ...
            toggleOverwrite: function(e) {
                null != e && e == this.state.overwrite || (((this.state.overwrite = !this.state.overwrite) ? A : S)(this.display.cursorDiv, "CodeMirror-overwrite"), be(this, "overwriteToggle", this, this.state.overwrite))
            },
            hasFocus: function() {
            ...
            scrollIntoView: Ir(function(e, t) {
                ...
                e.to || (e.to = e.from),
                    e.margin = t || 0,
                    null != e.from.line ? (n = e, Cr(t = this), t.curOp.scrollToPos = n) : Sr(this, e.from, e.to, e.margin)
            }),
            ...
            swapDoc: Ir(function(e) {
                var t = this.doc;
                return t.cm = null, this.state.selectingText && this.state.selectingText(), vi(this, e), Dn(this), this.display.input.reset(), xr(this, e.scrollLeft, e.scrollTop), this.curOp.forceScroll = !0, rn(this, "swapDoc", this, t), t
            }),
            phrase: function(e) {
    ...
    var Wl,
        Hl,
        Fl = "iter insert remove copy getEditor constructor".split(" ");
    ...
    return Se(ho), cl.inputStyles = {
        ...
        if ((n = n ? P(n) : {}).value = t.value, !n.tabindex && t.tabIndex && (n.tabindex = t.tabIndex), !n.placeholder && t.placeholder && (n.placeholder = t.placeholder), null == n.autofocus && (e = O(), n.autofocus = e == t || null != t.getAttribute("autofocus") && e == document.body), t.form && (me(t.form, "submit", r), !n.leaveSubmitMethodAlone)) {
            var i = t.form,
                o = i.submit;
            try {
            ...
            e.save = r,
                ...
                e.toTextArea = function() {
                    e.toTextArea = isNaN,
                        ...
                        t.style.display = "",
                    t.form && (ye(t.form, "submit", r), n.leaveSubmitMethodAlone || "function" != typeof t.form.submit || (t.form.submit = o))
                }
        },
